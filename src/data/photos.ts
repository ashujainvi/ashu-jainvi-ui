...
export const albums: Album[] = [
  {
    ...
    cover: { src: img8298, srcSet: img8298SrcSet, alt: 'Group Love Band portrait', width: 1500, height: 2000 },
    photos: [
      { src: img8298, srcSet: img8298SrcSet, alt: 'Group Love Band portrait', width: 1500, height: 2000 },
      { src: img8306, srcSet: img8306SrcSet, alt: 'Group Love Band on stage', width: 1500, height: 2000 },
      { src: img8320, srcSet: img8320SrcSet, alt: 'Group Love Band performance', width: 1500, height: 2000 },
      { src: img8259, srcSet: img8259SrcSet, alt: 'Group Love Band closeup', width: 1500, height: 2000 },
  ...
  },
  {
    id: 'bandits-fc',
    title: 'Bandits FC',
    description: 'Action and portrait shots from Bandits FC matches in Austin, TX',
    cover: { src: img4725, srcSet: img4725SrcSet, alt: 'Bandits FC wide action shot', width: 2000, height: 1333 },
    photos: [
      { src: img4725, srcSet: img4725SrcSet, alt: 'Bandits FC wide action shot', width: 2000, height: 1333 },
  ...
  },
  {
    ...
    cover: { src: imgVanta6767, srcSet: imgVanta6767SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
    photos: [
      { src: imgVanta6767, srcSet: imgVanta6767SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6772, srcSet: imgVanta6772SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6775, srcSet: imgVanta6775SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6786, srcSet: imgVanta6786SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6837, srcSet: imgVanta6837SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6852, srcSet: imgVanta6852SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6858, srcSet: imgVanta6858SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6867, srcSet: imgVanta6867SrcSet, alt: 'At Vanta office', width: 1536, height: 2048 },
      { src: imgVanta6873, srcSet: imgVanta6873SrcSet, alt: 'At Vanta office', width: 2048, height: 1365 },
      { src: imgVanta6914, srcSet: imgVanta6914SrcSet, alt: 'At Vanta office', width: 1365, height: 2048 },
      { src: imgVanta6962, srcSet: imgVanta6962SrcSet, alt: 'At Vanta office', width: 1536, height: 2048 },
