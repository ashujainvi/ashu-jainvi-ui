...
const About = () => (
  <>
    ...
    <section className={styles.prose}>
      <p>
        Hi, I am <strong className={styles.highlight}>Ashu</strong>. I have been a professional web developer
        for more than <strong>8 years</strong>. My career started as an intern summer 2017
        when I joined <strong>DSW&rsquo;</strong>.
      </p>
      <p>
        After completing my master&rsquo;s degree in 2018, I joined DSW
        full-time as a <strong>UI Engineer</strong> solving complex
        web app problems like analytics, accessibility, AB
        testing, performance, and SEO.
      </p>
      <p>
        I continued working as a <strong>Senior developer</strong> at DSW till 2020 end. Working
        across on the backend &amp; on the front end.
      </p>
      <p>
        At the end of 2022, I joined <strong>Apple</strong> as a{' '}
        <strong>Senior UI Developer</strong> as a consultant, where I used my expertise in
        architecting, documenting, redesigning, and rewriting
        an Apple-wide enterprise API management web platform.
      </p>
      <p>
